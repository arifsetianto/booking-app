        ...
        <ol class="mt-3 divide-y divider-gray-200 dark:divide-gray-700">
            @foreach($orders as $order)
                @if($order->id === $orderId)
                    <li>
                        <a wire:click="clickDetail('{{ $order->id }}')"
                           class="items-center block p-3 sm:flex bg-gray-100 hover:bg-gray-300 dark:hover:bg-gray-700 cursor-pointer">
                ...
                @else
                    <li>
                        <a wire:click="clickDetail('{{ $order->id }}')"
                           class="items-center block p-3 sm:flex hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer">
                            <div class="text-gray-600 dark:text-gray-400">
