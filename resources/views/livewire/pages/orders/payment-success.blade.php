...
<div>
    <div class="text-center">
        ...
        <p class="mt-1 text-gray-500">Your order will be processed as soon as we verify receiver's ID and the payment, usually within 1-7 working days. We will update your confirmation status in your login account. We've sent you status/tracking link, please click the button below:</p>
        <div class="py-6">
            <x-primary-button wire:click="redirectToTrackingOrder">
                {{ __('Check your order status here!') }}
            </x-primary-button>
        </div>
        <p class="mt-2 text-sm text-gray-500">Thank you for your cooperation.</p>
    </div>
</div>
