 ...
 */
class FixDoubleOrderAlreadyCompleted extends Command
{
    protected $signature = 'order:completed:fix-double';

    protected $description = 'Fix double order completed';
    ...
    public function getOrderQuery(): LazyCollection
    {
        return DB::table('orders')
                 ->where('status', operator: OrderStatus::COMPLETED)
                 ->whereIn(
                     'id',
